...
from core.dataset import VimeoDataset as VimeoDataset
...
def train(ppl, dataset_cfg_dict, optimizer_cfg_dict):
    ...
    val_data = DataLoader(dataset_val, batch_size=16,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight_decay', type=float, default=1e-4,
            help='wegith decay')
    parser.add_argument('--steps', type=float, default=200000,
